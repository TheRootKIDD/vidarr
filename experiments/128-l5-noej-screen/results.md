# 128-l5-noej-screen — failed at initialisation (driver/library version mismatch); id burnt, reruns as `136`
...
(`101`, `118`), so this id is burnt; **L5-noej seed 0 at 1e9 tokens reruns as `136`** in
`queue_small_3.sh`.
