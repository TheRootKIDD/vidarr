# 129-l7b-screen — failed at initialisation (driver/library version mismatch); id burnt, reruns as `137`
...
(`101`, `118`), so this id is burnt; **L7b seed 0 at 1e9 tokens reruns as `137`** in
`queue_small_3.sh`.
