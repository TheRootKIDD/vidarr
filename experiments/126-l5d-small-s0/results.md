# 126-l5d-small-s0 — failed at initialisation (driver/library version mismatch); id burnt, reruns as `134`
...
(`101`, `118`), so this id is burnt; **L5d seed 0 at 2.5e9 tokens reruns as `134`** in
`queue_small_3.sh`.
