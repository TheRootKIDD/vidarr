# 124-l5-small-s0 — failed at initialisation (driver/library version mismatch); id burnt, reruns as `132`
...
(`101`, `118`), so this id is burnt; **L5 seed 0 at 2.5e9 tokens reruns as `132`** in
`queue_small_3.sh`.
