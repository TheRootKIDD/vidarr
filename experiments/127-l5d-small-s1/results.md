# 127-l5d-small-s1 — failed at initialisation (driver/library version mismatch); id burnt, reruns as `135`
...
(`101`, `118`), so this id is burnt; **L5d seed 1 at 2.5e9 tokens reruns as `135`** in
`queue_small_3.sh`.
