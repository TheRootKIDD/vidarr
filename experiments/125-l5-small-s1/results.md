# 125-l5-small-s1 — failed at initialisation (driver/library version mismatch); id burnt, reruns as `133`
...
(`101`, `118`), so this id is burnt; **L5 seed 1 at 2.5e9 tokens reruns as `133`** in
`queue_small_3.sh`.
